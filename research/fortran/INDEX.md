...
| [makefile_optimizations_and_interface_lint_2026_06_16.md](makefile_optimizations_and_interface_lint_2026_06_16.md) | DONE (Phase 1a) | Makefile flag audit (10+ opts, shipped/rejected) + interface-lint program. g2g_timer interface module → implicit-interface 336→0 (bit-exact). Sized BLAS (~110) + internal (~360) + array-temp (305) for Phase 1b/2. Profiling: 9.2ms/iter g2g idle is the algorithmic pole |
