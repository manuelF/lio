...
| [optimize_gpu_allocator.md](optimize_gpu_allocator.md) | DONE (Tier 1) | Async pool via `cudaMallocAsync` — see async_pool doc below |
| [optimize_gpu_allocator_async_pool_2026_04_24.md](optimize_gpu_allocator_async_pool_2026_04_24.md) | DONE | Stream-ordered async pool: 1298 cudaMalloc/Free 100.7ms → 14.9ms; **−5% wall** on fosfatoQMMM |
